        ...
        <section className="flex-1 flex flex-col items-center justify-center bg-white px-8">
          <div className="w-full max-w-sm text-center">
            ...
            <div className="space-y-4">
              <button className="w-full py-4 bg-pink-600 hover:bg-pink-700 text-white font-bold rounded-xl transition-all shadow-lg shadow-pink-200"
                onClick={() => {router.push("/auth/login")}}
              >
                Sign In
              </button>
              <button className="w-full py-4 bg-white border-2 border-gray-200 hover:border-pink-600 hover:text-pink-600 text-gray-700 font-bold rounded-xl transition-all"
